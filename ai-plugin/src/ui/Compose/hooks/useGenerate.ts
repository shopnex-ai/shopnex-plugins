...
import type { ActionMenuItems, GenerateTextarea } from '../../../types'
...
import { useFieldProps } from '../../../providers/FieldProvider/useFieldProps'
import { editorSchemaValidator } from '../../../utilities/editorSchemaValidator'
import { setSafeLexicalState } from '../../../utilities/setSafeLexicalState'
  ...
  useEffect(() => {
    ...
    requestAnimationFrame(() => {
      ...
      if (validateObject?.success) {
        setSafeLexicalState(object as any, editor)
      }
    })
  }, [object, editor])
